...
- 2025-11-22 — Moved all pages from `src/legacy/portal/pages/` to `src/apps/static/pages/`; updated Vite build config to use new structure.
...
- 2025-10-31 — Reorganized app/pages under `src/apps/static/pages/*` (previously `src/legacy/portal/pages/*`); fixed Back to Portal links across pages.
- 2025-10-31 — Ported `about.html` → `src/apps/static/pages/about/index.html` (previously `src/legacy/portal/pages/about/index.html`); inlined Errl face SVG with glimmer animation.
