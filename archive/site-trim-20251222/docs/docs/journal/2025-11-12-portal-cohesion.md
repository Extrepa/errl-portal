...
- Legacy `src/apps/static/pages/studio/index.html` mirrors the new React `/studio` hub, keeping copy, cards, and roadmap content consistent no matter how the page is loaded.
...
- Created comprehensive component inventory registry (`docs/catalog/component-inventory.md`) tracking all ~205 components across 5 locations:
  ...
  - 5 projects components (`archive/legacy/standalone-pages/apps/projects/`)
...
- `docs/journal/2025-11-09-layer-cleanup.md`
- `docs/journal/2025-11-12-component-rips.md`
