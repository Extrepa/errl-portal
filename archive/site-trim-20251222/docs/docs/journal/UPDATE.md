...
- Canvas tools:
  - Add Text; Upload Image; Stickers: Star, Heart, Errl Face (uses `/src/assets/portal/L4_Central/errl-face-2.svg`).
...
- Preferred Errl face SVG: `/src/assets/portal/L4_Central/errl-face-2.svg`.
