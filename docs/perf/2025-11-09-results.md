...
Use this file to capture every measurement pass (Safari layers panel, graphics memory, compositing reasons, FPS notes). Historical screenshots/audits previously stored in `docs/perf/2025-11-09-safari-layers/` have been cleared; stash new captures in a fresh dated folder when you rerun metrics.
...
- Notes & screenshots: (cleared 2025-11-11). Re-capture on demand before publishing metrics.
...
| --- | --- | --- | --- | --- |
| Baseline (all on) | baseline() | _5.1? → update_ | _5.1? → update_ | (add new capture path on next run) |
...
4. Paste raw numbers above and drop assets into a new dated folder under `docs/perf/` (e.g., `docs/perf/2025-11-xx-safari-layers/NAME.png`).
